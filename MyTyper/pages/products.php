    ...
    for($i=0;$i<3;$i++)
{
    ...
    ?>
                ...
                <div class="d-flex align-items-center flex-column product-block">
                    <img class="product-image" src="../images/<?php echo $row['product_image']?>" alt="<?php echo $row['product_description'] ?>">
                    <h1>
...
echo "<form style='text-align:center;' method='post' action='singleCategory.php'><input class='viewCatForm' type='submit' value='$cat' name='submit'></input></form>";
}
?>
    <!DOCTYPE html>
    <html lang="en">
    ...
    <?php
    echo "<span style='border-bottom:solid black 4px;' class='container row d-flex justify-content-center'>";
        callCats($case);
    echo"</span>";
