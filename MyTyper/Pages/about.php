    ...
    <body>
        ...
        <nav class="navbar navbar-light bg-light fixed-top">
            <div class="container-fluid">
                ...
                <a class="navbar-brand" href="cart.php"><img class="cart-icon" src="../images/iconmonstr-shopping-cart-thin-72.png" alt="cart">
                    <p class="cart-count">
                        <?php if($_SESSION['cartCount'] == ""){echo "0";}else{ echo $_SESSION['cartCount'];} ?>
                    </p>
                </a>
        ...
        <main class="container column">
            <div class="main-div d-flex align-items-center flex-wrap flex-column">
                <img src="../images/mytyper_header.png" alt="">
                <h1>About Us</h1>
                <p>Since day one, MyTyper has sought out the highest quality materials and products for you to create your dream luxury mechanical keyboard to perfect your peripherals.</p>
            </div>
        </main>
        <footer>
