...
<?php
    //loop through the results set as a PHP associative array
...
?>
        <div class="productBlock">
            ...
            <p class="productName">Product Name: <?php echo $row['product_name']; ?></p>
            ...
            <?php
                ...
                {
                    echo "<p>".$row['product_status']."</p>";
                }
            ?>
            <!-- The productStatus element should only be displayed if there is product_status data in the record -->
            <p class="productStatus"><?php echo $row['product_name']; ?></p> 
            <?php
                $setInventory = "productInventory";
                if($row['product_inStock']<=10)
                {
                    $setInventory = "productLowInventory";
                }
            ?>          
            <p class="<?php echo $setInventory; ?>"><?php echo $row['product_inStock']." in stock"; ?></p>
        </div>
    <?php
        }//end for loop to display productBlock
    ?>
    </section>
